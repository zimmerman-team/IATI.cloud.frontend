...
const homeText: string[] = [
  ...
  "About Datastore",
  "The Datastore uses OIPA, an open-source tool created by Zimmerman & Zimmerman. OIPA extracts and stores raw IATI XML files from the IATI Registry and makes it available as API endpoints to build data driven information solutions.",
  "Query Builder",
  ...
  "API Documentation",
  "For guidance on how to form API queries and the available endpoints and filters please see the OIPA’s technical documentation.",
];
