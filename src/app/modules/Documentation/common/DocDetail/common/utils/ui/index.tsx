...
export function getEndpointPath(endpoint: any): string{
  ...
  if(endpoint.item[0] && endpoint.item[0].hasOwnProperty("item")){
    if(endpoint.item[0].item[0] && endpoint.item[0].item[0].hasOwnProperty("item")){
      if(endpoint.item[0].item[0].item[0] && endpoint.item[0].item[0].item[0].hasOwnProperty("item")){
      }else{
